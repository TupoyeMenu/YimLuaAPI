...
namespace GAME_BRANCH ::rage
{
	...
	{
		big::g_pointers->m_fipackfile_ctor((::rage::fiPackfile*)this);
	}

	fiPackfile::~fiPackfile()
	{
		big::g_pointers->m_fipackfile_dtor((::rage::fiPackfile*)this);
	}

	bool fiPackfile::OpenPackfile(const char* archive, bool b_true, int type, intptr_t very_false)
	{
		return big::g_pointers->m_fipackfile_open_archive((::rage::fiPackfile*)this, archive, b_true, type, very_false);
	}

	bool fiPackfile::Mount(const char* mount_point)
	{
		return big::g_pointers->m_fipackfile_mount((::rage::fiPackfile*)this, mount_point);
	}

	void fiPackfile::ClosePackfile()
	{
		big::g_pointers->m_fipackfile_close_archive((::rage::fiDevice*)this);
	}
